...
public class AdocaoService {
    ...
    public void solicitar(Adocao adocao) {
        ...
        this.emailService.enviar("adopet@email.com.br", adocao.getTutor().getEmail(), "Solicitação de adoção", "Olá " + adocao.getPet().getAbrigo().getNome()
    ...
    public void aprovar(Adocao adocao) {
        ...
        repository.save(adocao);
        this.emailService.enviar("adopet@email.com.br", adocao.getTutor().getEmail(), "Adoção aprovada", "Parabéns " +adocao.getTutor().getNome() +"!\n\nSua adoção do pet " +adocao.getPet().getNome() +", solicitada em " +adocao.getData().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss")) +", foi aprovada.\nFavor entrar em contato com o abrigo " +adocao.getPet().getAbrigo().getNome() +" para agendar a busca do seu pet.");
    }

    public void reprovar(Adocao adocao) {
        adocao.setStatus(StatusAdocao.REPROVADO);
        repository.save(adocao);
        this.emailService.enviar("adopet@email.com.br", adocao.getTutor().getEmail(), "Adoção reprovada", "Olá " +adocao.getTutor().getNome() +"!\n\nInfelizmente sua adoção do pet " +adocao.getPet().getNome() +", solicitada em " +adocao.getData().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss")) +", foi reprovada pelo abrigo " +adocao.getPet().getAbrigo().getNome() +" com a seguinte justificativa: " +adocao.getJustificativaStatus());
    }
}
